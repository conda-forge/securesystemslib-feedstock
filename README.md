About securesystemslib-feedstock
================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/securesystemslib-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/securesystemslib-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add securesystemslib
# for installing globally
pixi global install securesystemslib
```
...
It is possible to list all of the versions of `securesystemslib` available on your platform:
...
```
pixi search securesystemslib --channel conda-forge
```
